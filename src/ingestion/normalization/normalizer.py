...
def build_initial_schema(parsed: ParsedData) -> InitialSchema:
    ...
    return InitialSchema(
        ...
        fields=_normalized_fields(parsed_table_fields),
        entities=_normalized_entities(component_counts, parsed_table_fields),
...
def _normalized_fields(parsed_table_fields: dict[str, str] | None = None) -> dict[str, str]:
    return {
        **DOCUMENT_FIELDS,
        **TABLE_FIELDS,
